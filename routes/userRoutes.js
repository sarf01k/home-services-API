...
const { register, login, getUsers, logout, fetchUserProfile, editUserProfile } = require("../controllers/userController")
...
userRouter.post("/api/user/profile/password", cookieAuth, editUserProfile)
